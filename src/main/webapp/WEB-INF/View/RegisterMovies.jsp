	...
	<div class="container">
		...
		<form action="ShowMovies" method="get" class="movie-form">
			...
			<div class="form-group">
				<label for="movieTitle">Nome do Filme:</label> <input type="text"
					id="movieTitle" name="movieTitle" required>
			</div>
			<div class="form-group">
				<label for="movieDirector">Diretor:</label> <input type="text"
					id="movieDirector" name="movieDirector" required>
			</div>
			<div class="form-group">
				<label for="movieGenre">Gênero:</label> <input type="text"
					id="movieGenre" name="movieGenre" required>
			</div>
